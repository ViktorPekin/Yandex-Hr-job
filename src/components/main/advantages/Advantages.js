    ...
    <section className='advantages' id='advantages'>
      ...
      <div className='advantages__container'>
        <div className='advantages__card'>
          ...
          <img className='advantages__card-img' src={iconEducation} alt='Обучение' />
        </div>
        <div className='advantages__card'>
          ...
          <img className='advantages__card-img' src={iconChange} alt='Изменения' />
        </div>
        <div className='advantages__card'>
          ...
          <img className='advantages__card-img' src={iconRocket} alt='Развитие' />
        </div>
        <div className='advantages__card'>
          ...
          <img className='advantages__card-img' src={iconStairs} alt='Карьера' />
        </div>
      </div>
    </section>
  )
